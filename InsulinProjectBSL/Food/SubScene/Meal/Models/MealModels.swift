...
struct MealViewModel: MealViewModelCell {
  ...
  // protocol prop
  var products: [ProductCell] // То что пойдет в дополнительный лист
  ...
  init(isExpand: Bool, name: String,typeMeal: String, products: [MealViewModel.ProductCell],mealId: String?) {
  ...
  struct ProductCell: ProductViewModelCell {
