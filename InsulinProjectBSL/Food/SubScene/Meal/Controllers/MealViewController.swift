...
extension MealViewController: UITableViewDelegate, UITableViewDataSource {
  ...
  private func setProductListCLousers(cell:MealCell) {
    ...
    cell.productListViewController.didSelectTextFieldInMealCellClouser = { [weak self] textField in self?.setTextFiedlPoint(textField: textField) }
    
    cell.productListViewController.didChangePortionSizeClouser = {[weak self] portion,row,mealId in
