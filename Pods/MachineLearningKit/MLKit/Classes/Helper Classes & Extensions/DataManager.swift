...
open class MLDataManager {
     ...
     */
  public static func mean (_ data: Array<Float>) -> Float {
     ...
     */
  public static func dataToMatrix (_ features: [Array<Float>], output: Array<Float>) -> (Matrix<Float>, ValueArray<Float>) {
     ...
     */
  public static func convertMyDataToFloat(_ data: Array<String>) throws -> Array<Float> {
     ...
     */
  public static func splitData(_ data: Array<Float>, fraction: Float) throws -> (Array<Float>, Array<Float>) {
    ...
    /**
     ...
     contain whatever data is left.
     */
  public static func randomlySplitData(_ data: Array<Float>, fraction: Float) throws -> (Array<Float>, Array<Float>) {
     ...
     */
  public static func convertDataToPolynomialOfDegree(_ data: Array<Float>, degree: Int) throws -> [Array<Float>] {
     ...
     */
  public static func normalizeFeatures(_ features: [Array<Float>], output: Array<Float>) -> Matrix<Float> {
