...
open class BiologicalProcessManager {
     ...
     */
  public static func onePointCrossover(crossoverRate: Float, parentOneGenotype: [Float], parentTwoGenotype: [Float]) -> ([Float], [Float]) {
    ...
    */
  public static func bitFlipMutation(mutationRate: Float, genotype:inout [Float]) {
     ...
     */
  public static func swapMutation(mutationRate: Float, genotype:inout [Float]) {
     ...
     */
  public static func insertMutation(mutationRate: Float, genotype:inout [Float]) {
     ...
     */
  public static func scrambleMutation(mutationRate: Float, genotype:inout [Float]) {
     ...
     */
  public static func inverseMutation(mutationRate: Float, genotype:inout [Float]) {
